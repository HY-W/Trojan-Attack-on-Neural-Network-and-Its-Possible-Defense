...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        train_writer = tf.summary.FileWriter(logdir + r'\train', sess.graph)
        test_writer = tf.summary.FileWriter(logdir + r'\test', sess.graph)
    ...
    cpktLogFileName = r'.checkpoint\%05d.ckpt'
