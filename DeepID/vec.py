...
if __name__ == '__main__':
    testX1, testX2, testY = read_csv_pair_file(r'data\test_set.csv')
    validX, validY = read_csv_file(r'data\valid_set.csv')
    trainX, trainY = read_csv_file(r'data\train_set.csv')
